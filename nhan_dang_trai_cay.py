...
img_file_buffer = st.file_uploader("Upload an image", type=['bmp','jpg','jpeg','png'])
if img_file_buffer is not None:
    ...
    if st.button('Predict'):
        ...
        st.image(img, caption="Kết quả nhận diện", use_column_width=True)